...
public class Main {
    public static void main(String[] args) {
        ...
        OpenNoteView openNoteView = OpenNoteUseCaseFactory.create(viewManagerModel, openNoteViewModel, editNoteViewModel,openNoteUserDataAccessObject,editNoteUserDataAccessObject);
